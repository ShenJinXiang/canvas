<template>
  <div>
    <color-fireworks :width="controForm.width" :height="controForm.height" @click="showContro = true"></color-fireworks>
...
import ColorFireworks from '@/components/page/animation/ColorFireworks/index.vue';
